...
#define RtA 		57.2957795//57.324841				//弧度到角度// 180/PI=	57.2957795
#define AtR    	0.0174533				//度到角度  // PI/180=	 0.0174533
...
void Prepare_Data(void)
{
	...
	MPU6050_Read();   //读取6050数据
	MPU6050_Dataanl();//对6050数据进行处理 减去零偏 如果没有计算零偏进行计算
